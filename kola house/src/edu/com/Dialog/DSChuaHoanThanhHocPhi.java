 ...
 * @author Venus
 */
public class DSChuaHoanThanhHocPhi extends javax.swing.JDialog {

    /**
     * Creates new form DSChuaHoanThanhHocPhi
     */
    public JTabbedPane center;
    public DSChuaHoanThanhHocPhi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        new DataBase.DataTable().BangDanhSachHocSinhNoPhi(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Họ & Tên", "Lớp", "Kỳ", "Số Tiền Còn Nợ", "Check"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DSChuaHoanThanhHocPhi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DSChuaHoanThanhHocPhi dialog = new DSChuaHoanThanhHocPhi(new javax.swing.JFrame(), true);
